  ...
  return (
    <>
      ...
      >
        ...
        we decided to explore the capability of our NLP models when learning
        from human feedback. The idea is to create a web interface where users
        could rate the quality of the NLP model output (like summarization) and
      ...
      <Link as={NextLink} href="/summaries/pick">
        <Button rightIcon={<ArrowForwardIcon w={5} h={5} />}>Begin</Button>
      </Link>
    </>
  )
}
